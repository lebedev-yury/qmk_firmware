 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Hyper| Numb | Alt  | Cmd  | Symb | Space| Enter| Symb | Cmd  | Alt  |  Numb| Hyper|
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {ALL_T(KC_NO), NUMB,    KC_LALT, KC_LGUI, SYMB,    KC_SPC,  KC_ENTER,  SYMB,    KC_LGUI, KC_LALT, NUMB,    ALL_T(KC_NO)}
},
