 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Numb | Tmux | Alt  | Cmd  | Symb | Space| Enter| Symb | Cmd  | CAPS | Tmux | Numb |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {TT(_NUMB), LCTL(KC_B), KC_LALT, KC_LGUI, SYMB, KC_SPC,  KC_ENTER,  SYMB, KC_LGUI, KC_CAPS, LCTL(KC_B), TT(_NUMB)}
},
