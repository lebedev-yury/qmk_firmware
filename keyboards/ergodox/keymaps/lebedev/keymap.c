...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = KEYMAP(
    ...
    ALL_T(KC_NO),     MO(SYMB), MEH_T(KC_NO), KC_LALT, KC_LGUI,
    ...
    KC_CAPS,     KC_6, KC_7,    KC_8,     KC_9,         KC_0,      KC_AT,
    ...
    KC_UNDS,     KC_N, KC_M,    KC_COMMA, KC_DOT,       KC_SLASH,  KC_RSHIFT,
                       KC_LGUI, KC_LALT,  MEH_T(KC_NO), MO(SYMB),  ALL_T(KC_NO),
  ...
  [SYMB] = KEYMAP(
    ...
    KC_TRNS, KC_TRNS, KC_PIPE, KC_LBRACKET, KC_RBRACKET, KC_TILD,  KC_TRNS,
