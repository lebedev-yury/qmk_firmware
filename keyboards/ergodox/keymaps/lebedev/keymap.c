...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = KEYMAP(
    ...
    KC_UNDS,  KC_N, KC_M,    KC_COMMA, KC_DOT, KC_SLASH,  KC_RSHIFT,
  ...
  [SYMB] = KEYMAP(
    ...
    KC_TRNS, KC_AMPR, KC_1,   KC_2,  KC_3,     KC_BSLASH, KC_TRNS,
                      KC_DOT, KC_0,  KC_EQUAL, KC_TRNS,   KC_TRNS,

    KC_TRNS, KC_TRNS,
    KC_TRNS,
    KC_TRNS, CTL_T(KC_ESCAPE), KC_ENTER
  ),
  ...
  [MDIA] = KEYMAP(
    ...
    KC_TRNS, KC_TRNS, KC_AUDIO_MUTE,       KC_AUDIO_VOL_DOWN,   KC_AUDIO_VOL_UP,     KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_MEDIA_PREV_TRACK, KC_MEDIA_PLAY_PAUSE, KC_MEDIA_NEXT_TRACK, KC_TRNS, KC_TRNS,
